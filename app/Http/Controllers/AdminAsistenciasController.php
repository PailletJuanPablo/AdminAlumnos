	...
	class AdminAsistenciasController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			*/
			...
			$this->button_selected[] = ['label'=>'Marcar Presente','icon'=>'fa fa-check','name'=>'set_active','url'=>CRUDBooster::mainpath('set-status/active/[id]')];
			$this->button_selected[] = ['label'=>'Marcar Ausente','icon'=>'fa fa-times-circle','name'=>'ausente'];
	    ...
	    */
	    public function actionButtonSelected($id_selected,$button_name) {
			...
			if($button_name == 'set_active') {
				DB::table('asistencias')->whereIn('id',$id_selected)->update(['asistio'=>'SI']);
			  }

			  if($button_name == 'ausente') {
				DB::table('asistencias')->whereIn('id',$id_selected)->update(['asistio'=>'NO']);
			  }
	    }
