...
class AdminClasesController extends \crocodicstudio\crudbooster\controllers\CBController
{
    ...
    public function cbInit()
    {
        ...
        $curso = DB::table('actividades')->where('id', $idCurso)->first();
        ...
        $this->col[] = ["label" => "Actividad", "name" => "actividad_id", "join" => "actividades,nombre"];
        ...
        # OLD START FORM
        //$this->form = [];
        //if ($privilegio == 'Capacitador'){
        //
        //$this->form[] = ['label'=>'Actividad Académica','name'=>'actividad_id','type'=>'hidden','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'actividades,nombre', "value"=>$idCurso, "disabled"=>true, "hidden"=>true];
        //
        //}
        //
        //if ($privilegio !== 'Capacitador'){
        //
        //$this->form[] = ['label'=>'Actividad Académica','name'=>'actividad_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'actividades,nombre', "value"=>$idCurso];
        //
        //}
        //
        //$this->form[] = ['label'=>'Fecha','name'=>'fecha','type'=>'date','validation'=>'required|date','width'=>'col-sm-10'];
